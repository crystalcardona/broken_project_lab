...
//       `UPDATE cars SET brand=${brand}, model=${model}, year=${year}, owner_id=${owner_id} RETURNING *`, req.body.params)
//       {
...
module.exports = { getAllCars, getSingleCar, createCar, deleteCar };
